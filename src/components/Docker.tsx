    ...
    <div className="steps-container step">
      ...
      <ol className="description-text">
        ...
        <li>
          ...
          directory on the machine you want to run the service on (e.g. a web
          server)
        </li>
        <li>
          In this directory, execute `docker-compose --env-file dm3-ds.env up
          -d` to start the delivery service
        </li>
        <li>
          Visit &lt;yourUrl&gt;:8083/hello with your web browser to get a first
          friendly response from your delivery service
        </li>
      </ol>
    </div>
  );
