...
export const configureEnv = (keys: DeliveryServiceProfileKeys, rpc: string, ensDomain: string,
    url: string, address: string, keyCreationMessage: string, profile: DeliveryServiceProfile
) => {
